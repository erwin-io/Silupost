...
namespace SilupostWeb.OAuth.Filters
{
    ...
    public class SilupostWebHttpActionResult<T> : IHttpActionResult
    {
        ...
        public SilupostWebHttpActionResult(HttpRequestMessage request, HttpStatusCode status, T content)
        {
