    ...
    public class SystemWebAdminMenuRolesController : ApiController
    {
        ...
        public IHttpActionResult GetBySystemWebAdminRoleIdAndSystemWebAdminModuleId(string SystemWebAdminRoleId, long SystemWebAdminModuleId)
        {
            ...
            try
            {
                ...
                return new POSAPIHttpActionResult<AppResponseModel<List<SystemWebAdminMenuRolesViewModel>>>(Request, HttpStatusCode.OK, response);
        ...
        public IHttpActionResult SetSystemWebAdminMenuRoles([FromBody] SystemWebAdminMenuRolesBindingModel model)
        {
            ...
            if (model != null && string.IsNullOrEmpty(model.SystemWebAdminRoleId))
            {
                ...
                return new POSAPIHttpActionResult<AppResponseModel<List<SystemWebAdminMenuRolesViewModel>>>(Request, HttpStatusCode.BadRequest, response);
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    return new POSAPIHttpActionResult<AppResponseModel<List<SystemWebAdminMenuRolesViewModel>>>(Request, HttpStatusCode.BadGateway, response);
                }
            }
            catch (Exception ex)
            {
