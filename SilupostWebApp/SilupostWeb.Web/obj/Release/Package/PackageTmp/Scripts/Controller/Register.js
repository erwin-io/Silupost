var registerController = function(){
    ...
    var init = function () {
        api = new apiService(app.appSettings.silupostWebAPIURI);
        initLookup();
        setTimeout(function () {
                            ...
                            if (result.IsSuccess) {
                                ...
                                var appState = {
                                    User: {
                                        ...
                                        ProfilePictureSource: app.appSettings.silupostWebAPIURI + "File/getFile?FileId=" + result.Data.ProfilePicture.FileId,
