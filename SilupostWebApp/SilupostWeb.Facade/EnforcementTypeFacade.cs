...
namespace SilupostWeb.Facade
{
    public class EnforcementTypeFacade : IEnforcementTypeFacade
    {
        ...
        public EnforcementTypeViewModel Find(string id)
        {
            var result = AutoMapperHelper<EnforcementTypeModel, EnforcementTypeViewModel>.Map(_enforcementTypeRepositoryDAC.Find(id));
