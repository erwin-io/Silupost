    ...
    var Save = function(e){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                circleProgress.show(true);
                $.ajax({
                    url: app.appSettings.silupostWebAPIURI + "/SystemUser/UpdatePersonalDetails",
                    type: "PUT",
                    dataType: "json",
                    contentType: 'application/json;charset=utf-8',
    ...
    var SaveUsername = function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                circleProgress.show(true);
                $.ajax({
                    url: app.appSettings.silupostWebAPIURI + "/SystemUser/UpdateUsername",
                    type: "PUT",
                    dataType: "json",
                    contentType: 'application/json;charset=utf-8',
    ...
    var SavePassword = function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                circleProgress.show(true);
                $.ajax({
                    url: app.appSettings.silupostWebAPIURI + "/SystemUser/UpdatePassword",
                    type: "PUT",
                    dataType: "json",
                    contentType: 'application/json;charset=utf-8',
